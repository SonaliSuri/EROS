...
import BrokerPrivateOwner from "./BrokerPrivateOwner";
// Step titles
const labels = ["Account type", "Registration", "Verify Details", "Payment"]
...
function StepForm  () {
  ...
  const handleSteps = step => {
    switch (step) {
      case 0:
        return (
          <BrokerFirstStep handleNext={handleNext} handleChange={handleChange} values={formValues} formErrors={formErrors} />
          
        )
      case 1:
        return (
            <BrokerPrivateOwner handleNext={handleNext} handleBack={handleBack} values={formValues} formErrors={formErrors}/>
        )
